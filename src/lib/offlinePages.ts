/** Service worker cache name - keep in sync with public/sw-v12.js */
export const SW_CACHE = 'lm-v12'

/** Static assets precached for offline Grind (see public/sw-v12.js). */
