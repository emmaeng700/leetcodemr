/** Service worker cache name - keep in sync with public/sw-v11.js */
export const SW_CACHE = 'lm-v11'

/** Static assets precached for offline Grind (see public/sw-v11.js). */
