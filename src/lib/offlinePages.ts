/** Service worker cache name - keep in sync with public/sw-v13.js */
export const SW_CACHE = 'lm-v13'

/** Static assets precached for offline Grind (see public/sw-v13.js). */
