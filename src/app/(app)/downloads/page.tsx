...
const FILES = [
  ...
  {
    title: 'Study-Order PDF — 2×1 Landscape (Phone-Optimised)',
    description: '331 questions, 2 mini-pages per sheet — each question takes half a landscape page so text scales up ~1.9×. Every TOC link jumps precisely to the exact column on the destination sheet so you land directly on the question with no panning. Checkboxes, ← Contents button, Chapter 2 master summary. Best for mobile.',
    file: 'LeetMastery_Study_Order_2x1_Landscape.pdf',
    size: '9.4 MB',
    icon: FileText,
    accent: 'from-sky-500 to-cyan-600',
    badge: 'PDF · 2×1 · Mobile',
