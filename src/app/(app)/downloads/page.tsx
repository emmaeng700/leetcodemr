...
const FILES = [
  ...
  {
    title: 'pattern_run',
    description: '331 questions in priority study order. Syntax-highlighted code, problem descriptions, inline key insights after every solution. 2 questions per landscape page — precise tap-to-question links, checkboxes to track progress. Built for mobile.',
    file: 'pattern_run.pdf',
    size: '9.3 MB',
    icon: FileText,
  ...
  {
    title: 'the_digest',
    description: '331 questions — key insights, space & time complexity, and solution explanation. One per page, no code, pure concept. Read it anywhere.',
    file: 'the_digest.pdf',
    size: '716 KB',
    icon: FileText,
