...
async function main() {
  ...
  console.log(
    `Wrote public/grind_questions.json (${rows.length} questions, ${withIa} interview approaches, ${pyWithExInStarter} python starters include Examples/Test, ${pyWithIaInStarter} include interview)`,
  )
}
